...
This project demonstrates an end-to-end data warehousing solution, including:
- Data ingestion from ERP and CRM systems
- Data cleansing and transformation
- Dimensional modeling for analytics
- SQL-based reporting and insights

It is designed as a **portfolio project** for aspiring Data Engineers and Data Analysts.
